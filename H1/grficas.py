...
rec1 = np.loadtxt('SNRrec1126084608.out',usecols=(0))

exp1 = np.loadtxt('SNRexp1126084608.out',usecols=(0))

tt1 = np.loadtxt('TT1126084608.out',usecols=(0))

ti1 = np.loadtxt('TI1126084608.out',usecols=(0))

flag1 = np.loadtxt('FLAG1126084608.out',usecols=(0))
