...
def principal(runs,archivo_nombre,local,ifo):
...
#	our proposed signal with the data.
    ...
    np.savetxt('Total'+str(archivo_nombre)+ifo+'.out',(SNRrec,SNRexp,total_flag,trigger_time,injection_time),fmt='%3.2f')
...
files = [1126727680,1126731776,1126739968,1126744064,1126748160,1126752256,1126756352,1126760448,1126768640,1126772736]

for fila in files:

    
    t = multiprocessing.Process(target=principal, args=(2,fila,loc,ifo))
